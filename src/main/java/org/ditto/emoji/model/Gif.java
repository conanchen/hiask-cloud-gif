...
public class Gif implements Serializable {
    ...
    private Gif(String line, String codepoint, String codepointu16, String groupId, String subgroupId, String name, int sequence, long lastUpdated, boolean active) {
        this.line = line;
    ...
    public static final class Builder {
        ...
        public Gif build() {
            ...
            return new Gif(line,  codepoint,   codepointu16,   groupId,   subgroupId,   name,   sequence,   lastUpdated,   active) ;
        }
