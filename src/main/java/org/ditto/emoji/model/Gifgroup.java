...
public class Gifgroup {
    ...
    private Gifgroup(String line, String id, String groupId, String subgroupId, String name, int sequence, long lastUpdated, boolean active) {
        this.line = line;
        this.id = id;
    ...
    public static final class Builder {
        ...
        public Gifgroup build() {
            ...
            return new Gifgroup(line,id, groupId, subgroupId, name, sequence, lastUpdated,active);
        }
